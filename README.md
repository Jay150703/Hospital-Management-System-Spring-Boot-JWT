...
spring.datasource.url=jdbc:mysql://localhost:3306/hospital_db spring.datasource.username=root spring.datasource.password=yourpassword

spring.jpa.hibernate.ddl-auto=update spring.jpa.show-sql=true

server.port=8080

jwt.secret=your_secret_key jwt.expiration=86400000
...
Conclusion
This project demonstrates how to build a secure backend application using Spring Boot and JWT. It is simple, practical, and ideal for learning, viva, and project submission.
